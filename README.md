...
Uma análise global dos atributos apontou que a ausência sequencial de registros, ainda que menor que 75% do período apurado, poderia fragilizar o futuro modelo. Contando com uma quantidade de atributos suficiente de atributos na base, optou-se pela eliminação daqueles que apresentassem quantidade de registros nulos maior que 150, pois, ainda assim, continuar-se-ia com uma dataset significativo, com registros de 136 atributos válidos.
